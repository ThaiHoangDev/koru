...
<path d="M15 1.25C15 9.71154 15 13.109 15 13.75" stroke="#000" stroke-width="2.5" stroke-linecap="round"/>
</svg>
`;

export default ({ width, height, stroke }: any) => (
  <SvgXml xml={xmlNormal} width={width} height={height} color={stroke} />
);
